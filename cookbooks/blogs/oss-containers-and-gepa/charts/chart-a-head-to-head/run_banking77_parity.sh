...
# Boots the live container, runs gepa-ai + Synth GEPA against it with comparable
# run caps, parses tokens + computes USD cost, and prints the comparison.
#
# Usage (from repo root):
#   export OPENAI_API_KEY=...
#   bash cookbooks/blogs/oss-containers-and-gepa/charts/chart-a-head-to-head/run_banking77_parity.sh
...
CHART_DIR="${REPO_ROOT}/cookbooks/blogs/oss-containers-and-gepa/charts/chart-a-head-to-head"
PORT="${PORT:-8810}"
...
uv run --with "synth-optimizers @ git+https://github.com/synth-laboratories/optimizers.git@d5acd9c3464fd28fda0a0d417b0cd4418152ab62" synth-optimizers gepa run \
