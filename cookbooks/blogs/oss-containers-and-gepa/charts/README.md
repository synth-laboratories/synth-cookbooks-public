...
Current post producers are **A**, **C**, and **D** only. Historical and future
addenda are not committed in this launch packet; re-add them only with fresh
evidence packets and an explicit active-MDX section.
...
python cookbooks/blogs/oss-containers-and-gepa/charts/chart-d-proposer-scaling/build_chart.py
```
